...
import styles from '../../styles/components/SpacePageSideBarRightPlaceholder.module.scss'

const SpacePageSideBarRightPlaceholder = (): JSX.Element => {
    // const { spaceContextLoading } = useContext(SpaceContext)

    return (
        <div className={styles.PHSideBarRight}>
...
export default SpacePageSideBarRightPlaceholder
