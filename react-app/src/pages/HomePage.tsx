    ...
    return (
        <div className={styles.homePage}>
            <div className={styles.mainContent}>
                ...
                <h1>
                    we{`{`}
                    <span className={styles.coloured}>collective</span>
                    {`}`}
                </h1>
                {/* </div> */}
                <h2>holonic social media, by the people</h2>
                <h3>cooperatively owned • democratically governed • open source</h3>
            ...
            <div className={styles.section2}>
                <div className={styles.introText}>
                    <h4>
                        ...
                        design. */}
                        {/* is an evolving experiment in social media, community governance, and collective intelligence design. */}
                        is an evolving experiment in social media design, cooperative ownership, and collective intelligence.
                    </h4>
                    <br />
                    <p>
                        The platform is built around a nested{' '}
                    ...
                    <br />
                    <img src='https://miro.medium.com/max/1400/1*dJltVFtaVwh4CIPBXNOV1A.jpeg' style={{ width: 400, marginBottom: 20 }} />
                    <p>
                        Within this framework we’re developing a range of unique post types and
                        community modules designed to meet an expanding variety of collaborative needs for
                        communities.
                    </p>
                    <br />
                    {/* <p>
                    ...
                    <p>
                        ...
                        involved we’ll be transitioning into a platform cooperative, fully owned
                        and governed by its members. Members of the coop will then be able to propose and
                        vote on new features they’d like built into the platform, as well as how
                        surplus profits generated by the site are spent. Learn more about our plans for the coop and its governance [here].
                    </p>
                    <br />
                    <p>
                        The website is currently being developed primarily as a passion project by James Weir.
                        If enough funding can be raised, a dedicated development team will be
                        established to work full time on the project in conjunction with open
                        source collaborators. If you'd like to get involved or have any other queries,
